...
func (m *testDBRepo) GetRestrictionsForRoomsByDate(roomID int, start, end time.Time) ([]models.RoomRestriction, error) {
...
func (m *testDBRepo) DeleteBlockForRoomByID(id int) error {
	return nil
}
